  		...
  		<div class="col-sm-6 col-md-4">
            ...
            <div class="pic pic-3d" style="padding: 10px 10px 10px 10px;">
               <c:if test="${! empty meetMem.meet.meetImg}">
                <img src="/resources/images/uploadFiles/meet/${meetMem.meet.meetImg}" alt="MORACK MORACK" class="img-circle" style="height:300px; width:300px" id="meetImg"></c:if>
                 ...
                 <br/><p id="meetName">${meetMem.meet.meetName}</p>
                 <input type="hidden" value="${meetMem.meet.meetId}"/>
                 <p>가입 날짜 : <fmt:formatDate value="${meetMem.joinDate}" pattern="yyyy.MM.dd" /></p>
                 <p>인원 수 : ${meetMem.meet.memNum}/${meetMem.meet.maxNum}</p>
                 <p>모임 카테고리 : ${meetMem.meet.category}</p>
                 </div>
            </div>
 			 </div>  
 			 </c:forEach>
